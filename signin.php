...
<html>
	<head>
	<title>Connecting Peoples</title>
	<meta charset="uft-8">
	<link rel="icon" href="./img/title.png" type="image/x-icon">
	<link rel="image_src" href="http://www.daowat.com/userdata/daowat_pics/nur/1453542261.jpg" /><!--formatted-->
	<link rel="stylesheet" type="text/css" href="./css/style.css">
	<meta name="description" content="Welcome To WeChat. Join WeChat. Connect with your family and friends. Get update over the world." /><!--formatted-->
	    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	    <meta name="author" content="Tarun Tiwari">
		...
		<div class="main">
			<div class="headerLogin">
				<div class="login_menubar clearfix">
					<div class="menu_logo">
						<h1>
							<a title="Go to WeChat Home" href="index.php">
								<b>WeChat</b>
							</a>
						</h1>
					</div>
							...
							<div class="maincontent">
							   <?php
								if (isset($success_message)) {
									...
									echo '
									   <h2><font face="bookman">Welcome To WeChat!</font></h2>
										<div class="maincontent_text">
										<font face="bookman">Join WeChat.com <br>
											<li>Connect with your family and friends.</li>
